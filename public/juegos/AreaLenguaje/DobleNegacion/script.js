...
var planetas = randomValueGenerator(["planetas/1.png", "planetas/2.png", "planetas/3.png", "planetas/4.png", "planetas/5.png", "planetas/6.png", "planetas/7.png", "planetas/8.png", "planetas/9.png", "planetas/10.png", "planetas/11.png", "planetas/12.png", "planetas/13.png", "planetas/14.png", "planetas/15.png"])

function pintardivs(){
    let divss = "";
    for (let index = 0; index < 15; index++) {
        divss += "<div class='wave' style='background-image: url("+planetas[index]+")'>"+
...
function preguntar() {
    ...
    for (let index = ultimo; index < ultimo + 3; index++) {
        ...
        elemento.innerHTML = "<p class='borde' id='pregunta"+index+"'>"+ element[0]+"</p>";
