    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          maquina2(
            "bienvenida",
            "Hola, soy Genio. <br> En este juego deberas llegar primero a la meta, para esto debes responder correctamente las preguntas presentadas para poder tomar la delantera.  <br> ¡Tú Puedes!",
            50,
            1
          );
        }, 3000);
