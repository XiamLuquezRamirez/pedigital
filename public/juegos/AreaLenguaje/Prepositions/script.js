        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    maquina2("bienvenida", 'Hola, soy Genio. <br> A continuación se te mostraran 5 oraciones de las cuales deberás seleccionar la preposición correspondiente <br> ¡Tu puedes!', 50, 1);
                }, 3000)
            }, 2000)
        })
    }, 200)
