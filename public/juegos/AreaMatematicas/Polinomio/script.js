        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    maquina2("bienvenida", 'Hola, soy Genio. <br> A continuación se te presentaran 10 polinomios, resuelvelos y selecciona la respuesta correcta, responde mas de 6 preguntas correctamente para ganar el juego. <br> ¡Tu puedes!', 50, 1);
                }, 3000)
            }, 2000)
        })
    }, 200)
