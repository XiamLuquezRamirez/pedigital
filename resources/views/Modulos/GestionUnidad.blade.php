...
<input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ url('/Modulos/NuevaUnidad') }}" title="Nueva Unidad">
                                                ...
                                                <div class="col-md-4">
                                                    {!! Form::model(Request::all(), ['url' => '/Modulos/GestionUnid', 'method' => 'GET', 'autocomplete' => 'off', 'role' => 'search', 'class' => '']) !!}
                                                    <div class="form-group">
                                ...
                                <p class="px-1"></p>
                                @include('Modulos.paginacionUnidad')
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <form action="{{ url('/Modulos/ReasignarUnidades') }}"
    ...
    {!! Form::open(['url' => '/Modulos/EliminarUnidad', 'id' => 'formAuxiliar']) !!}
    {!! Form::close() !!}

    {!! Form::open(['url' => '/Modulos/CargarUnidadesReasignar', 'id' => 'formAuxiliarUniades']) !!}
    {!! Form::close() !!}
        ...
        $(document).ready(function() {
            ...
            $.extend({
                ...
                ReasignarUnidades: function(){
                    ...
                    mensaje = "¿Desea Reasignar las Uniades Seleccionadas?";
                    Swal.fire({
                        title: 'Gestionar Unidades',
                        text: mensaje,
                        icon: 'warning',
