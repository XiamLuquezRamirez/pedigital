...
@section('title', 'Gestionar Contenido Tematico Módulos Transversales')
@section('Contenido')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-12 col-12 mb-2">
            <h3 class="content-header-title mb-0">GESTIONAR CONTENIDO TEMATICO MÓDULOS TRANSVERSALES</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/Administracion') }}">Inicio</a>
                        </li>
                        <li class="breadcrumb-item active">Gestionar Contenido Tematico Módulos Transversales
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Gestionar Contenido Tematico Módulos Transversales</h4>
                        </div>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="btn-list">
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ url('/Modulos/NuevoTema') }}" title="Nuevo Tema">
                                                    ...
                                                    @foreach ($Temas as $Tem)
                                                        <tr data-id='{{ $Tem->id }}' id='Tema{{ $Tem->id }}'>
                                                            <td class="text-truncate">
                                                                <a href='{{ url('Modulos/EditarTema/' . $Tem->id) }}'
                                                                    title="Editar"
                                                                ...
                                                                <a href='{{ url('Modulos/GestionAsigEvaluacion/' . $Tem->id) }}'
                                                    ...
                                                    <div class="row pt-1">
                                                        ...
                                                        <diV class="col-md-2 text-right" style="display: none;"
                                                            ...
                                                            <a class="btn btn-outline-success"
                                                                onclick="$.ReasignarTemas();" title="Buscar Estudiantes">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="table-responsive">
                                                                <form action="{{ url('/Modulos/ReasignarTemas') }}"
                                ...
                                <p class="px-1"></p>
                                @include('Modulos.paginacionTema')
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {!! Form::open(['url' => '/Modulos/ElimnarTema', 'id' => 'formAuxiliar']) !!}
    {!! Form::close() !!}

    {!! Form::open(['url' => '/Modulos/CargarTemasReasignar', 'id' => 'formAuxiliarTemas']) !!}
    {!! Form::close() !!}
