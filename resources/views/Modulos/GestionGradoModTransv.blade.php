...
@section('title', 'Gestionar Grados Módulos')
@section('Contenido')

    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Gestionar Grados Módulos</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/Administracion') }}">Inicio</a>
                        </li>
                        <li class="breadcrumb-item active">Gestionar Grados Módulos
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ url('/Modulos/NuevoGrado') }}" title="Nuevo Grado">
                                                ...
                                                <div class="col-md-5">
                                                    {!! Form::model(Request::all(), [
                                                        'url' => '/Modulos/GestionGradosModTransv',
                                                        'method' => 'GET',
                                                        'autocomplete' => 'off',
                                                        'role' => 'search',
                                                    ]) !!}
                                ...
                                <p class="px-1"></p>
                                @include('Modulos.PaginacionGradModTransv')
    ...
    {!! Form::open(['url' => '/Modulos/EliminarGradModTransv', 'id' => 'formAuxiliar']) !!}
    {!! Form::close() !!}
