            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Crear Grados Módulos Transversales
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Crear Grado Módulos Transversales.</h4>
                        </div>
                        <div class="card-content collapse show">
                            <div class="card-body">
                                ...
                                @include('Modulos.FormGradModTransv', [
                                    'url' => '/Modulos/GuardarGradoModTransv',
                                    'method' => 'post',
                                ])
                                <!--end::Form-->
                                <p class="px-1"></p>
            ...
            $("#AddPeriodo").on({
                click: function(e) {
                    ...
                    $('#tr_periodos input').each(function() {
                        if ($(this).val() === perio) {
                            Swal.fire('Gestionar Grados!', 'Este Periodo ya ha sido Asignado...',
                                'warning');
                            flag = "no";
                        }
                    });
                ...
                if (PorcTot > 100) {
                    ...
                    campo += "<input type='hidden' id='txtperi" + ConsPer +
                        "' name='txtperi[]' class='txtperi'   readonly style='" + style + "' value='" +
                        perio +
                        "'><input type='hidden' id='' name='txtidperi[]'  value='0'>";
                    campo += "<input type='hidden' id='txtporc" + ConsPer +
                        "' name='txtporc[]' class='PorcPer'  readonly style='" + style + "' value='" + porc + "'>";
                    campo += "</td>";
                    campo += "</tr>";
