...
@section('Contenido')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Gestionar Simulacros Módulo E</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/Administracion') }}">Inicio</a>
                        </li>
                        <li class="breadcrumb-item active">Gestionar Simulacros Módulo E
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Gestionar Simulacros</h4>
                    </div>
                    <div class="card-content collapse show">
                        <div class="card-body">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <a class="btn btn-outline-primary"
                                                        href="{{ url('/ModuloE/NuevoSimulacro') }}"
                                                        title="Nueva Competencia">
                                                        <i class="fa fa-plus"></i> Crear Simulacro
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <p class="px-1"></p>
                            @include('ModuloE.PaginacionSimulacros')
                        </div>
                    </div>
                </div>
            </div>
    ...
    {!! Form::open(['url' => '/ModuloE/EliminarSimulacro', 'id' => 'formAuxiliar']) !!}
    {!! Form::close() !!}
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                error: function() {
                                    mensaje = "El Simulacro no pudo ser Eliminado";
                                    Swal.fire({
                                        title: "Gestionar Módulo E",
                                        text: mensaje,
                                        icon: "warning",
