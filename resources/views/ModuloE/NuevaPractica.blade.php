...
@section('title', 'Crear Preguntas para Practica')
@section('Contenido')
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Crear Preguntas para Practica
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Crear Preguntas.</h4>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.extend({
                ...
                hab_edi: function() {
                    $("#cont_sumer").html(
                        '<textarea name="summernoteCont"  id="summernoteCont" class="summernote"></textarea>'
                    );
                ...
                hab_ediContCompOpc: function() {
                    CKEDITOR.replace('summernoteCompOpc', {
                        width: '100%',
                        height: 200
                    });
                    ...
                    $.ajax({
                        ...
                        success: function(respuesta) {
                            if (respuesta) {
                                $("#Id_Eval").val(respuesta.idEval);
                                Swal.fire({
                                    title: "Gestionar de Evaluaciones",
                                    text: "Operación Realizada Exitosamente",
                                    icon: "success",
                                    button: "Aceptar",
                                });
