...
@section('title', 'Gestionar Competencias Módulo E')
@section('Contenido')

    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Gestionar Competencias Módulo E</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/Administracion') }}">Inicio</a>
                        </li>
                        <li class="breadcrumb-item active">Gestionar Competencias Módulo E
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Gestionar Competencias</h4>
                    </div>
                    <div class="card-content collapse show">
                        <div class="card-body">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <a class="btn btn-outline-primary"
                                                        href="{{ url('/ModuloE/NuevaCompetencia') }}"
                                                        title="Nueva Competencia">
                                                        <i class="fa fa-plus"></i> Crear Competencia
                                                    </a>
                                                </div>
                                            </div>
                            ...
                            <p class="px-1"></p>
                            @include('ModuloE.PaginacionCompetencias')
                        </div>
                    </div>
                </div>
            </div>
    ...
    {!! Form::open(['url' => '/ModuloE/EliminarCompetencia', 'id' => 'formAuxiliar']) !!}
    {!! Form::close() !!}
