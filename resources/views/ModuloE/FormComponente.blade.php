...
<h4 class="form-section"><i class="ft-grid"></i> Información de Componente</h4>
<div class="row">

    <div class="col-md-9">
        <div class="form-group">
            <label class="form-label" for="direccion_alumno">Nombre Componente:</label>
            {!! Form::text('nombre', old('nombre', $Comp->nombre), ['class' => 'form-control', 'placeholder' => 'Nombre del Componente', 'id' => 'nombre']) !!}
        </div>
    </div>
    <div class="col-md-3">
        ...
        <div class="col-md-12 col-lg-12 ">
            <div class="btn-list">
                @if ($opc != 'Consulta')
                    ...
                    @if ($opc != 'editar')
                        <a class="btn btn-outline-warning" href="{{ url('/ModuloE/NuevoComponente') }}"
                            title="Cancelar">
                            <i class="fa fa-close"></i> Cancelar
                        </a>
                    @endif
                @endif
                <a class="btn btn-outline-dark" href="{{ url('/ModuloE/GestionComponente') }}" title="Volver">
