            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Crear Preguntas
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.extend({
                ...
                CargPartes: function(id) {
                    ...
                    $.ajax({
                        ...
                        success: function(respuesta) {
                            $("#tema").html(respuesta.select_temas);
                          // $.CargPartes();
                ...
                DelPreguntasOpcMult: function(id_fila) {
                    ...
                    if ($("#id-preopcmult" + id_fila).val() !== "") {
                        ...
                        form.append("<input type='hidden' name='id' id='idAuxiliar' value='" + preg +
                            "'>");
                        form.append("<input type='hidden' name='TipPregu' id='TipPregu' value='OPCMULT'>");
                        var url = form.attr("action");
                        var datos = form.serialize();
                        var mensaje = "";
                ...
                Hab_TextComp: function(cons) {
                    CKEDITOR.replace('TextComp', {
                        width: '100%',
                        height: 150
                    });
                },
