        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if (Auth::user()->tipo_usuario == 'Profesor')
                ...
                @if (Session::get('PerZonL') == 'si')
                    <li id="Men_ZonaVis" class=" nav-item"><a
                            href="{{ url('/Contenido/ZonaLibre/' . Auth::user()->id) }}"><i class="ft-airplay"></i><span
                                class="menu-title" data-i18n="">Zona
                                Libre</span></a>
                    </li>
                @endif
                ...
                @if (Session::get('IDMODULO') != '')
                    @if (Session::get('TIPCONT') == 'ASI')
                        ...
                        <li id="Men_Contenido"><a
                                href="{{ url('/Contenido/Contenido/' . Session::get('IDMODULO')) }}"><i
                                    class="ft-list"></i><span class="menu-title" data-i18n="">Contenido</span></a>
                        </li>
                    @else
                        <li id="Men_Presentacion" class="active"><a
                    ...
                    @if (Session::get('TIPCONT') == 'ASI')
                        <li id="Men_Asistencia" class=" nav-item"><a href="{{ url('/Profesores/asistencia') }}"><i
                                    class="ft-clipboard"></i><span class="menu-title"
                                    data-i18n="">Asistencia</span></a>
                        </li>
                    @else
                        <li id="Men_Asistencia" class=" nav-item"><a href="{{ url('/Profesores/asistenciaMod') }}"><i
                                    class="ft-clipboard"></i><span class="menu-title"
                                    data-i18n="">Asistencia</span></a>
                        </li>
                    @endif
                        ...
                        <li id="Men_Modulos" class=" nav-item"><a href="#"><i class="fa fa-book"></i><span
                            ...
                            <ul class="menu-content">
                                <li id="Men_Modulos_addAdig"><a class="menu-item"
                                        href="{{ url('/Modulos/GestionGradosModTransv/') }}"><i class="ft-list"></i>
                                        Grados</a>
                                </li>
                        ...
                        <li id="Men_Modulos_E" class=" nav-item"><a href="#"><i class="fa fa-book"></i><span
                            ...
                            <ul class="menu-content">
                                ...
                                <li id="Men_ModulosE_addPre"><a class="menu-item"
                                        href="{{ url('/ModuloE/GestionBancoPreguntas/') }}"><i class="ft-list"></i>
                                        Banco de Preguntas</a>
                                </li>
                                <li id="Men_ModulosE_addSimulacro"><a class="menu-item"
                                        href="{{ url('/ModuloE/GestionSimulacros/') }}"><i class="ft-list"></i>
                                        Simulacros</a>
                                </li>
            ...
            @if (Auth::user()->tipo_usuario == 'Estudiante')
                ...
                @else
                    ...
                    @if (Session::get('PerModE') == 'si')
                        <li id="Men_ModuloE" class=" nav-item"><a href="{{ url('/ModuloE/CargarContModuloE') }}"><i
            ...
            @if (Auth::user()->tipo_usuario == 'Administrador')
                <li id="Men_Inicio" class="active" class=" nav-item"><a href="{{ url('/Administracion') }}"><i
                            class="ft-home"></i><span class="menu-title" data-i18n="">Tablero</span></a>
                </li>
                @if (Session::get('IDMODULO') != '')
                    @if (Session::get('TIPCONT') == 'ASI')
                        <li id="Men_Presentacion" class="active"><a
                    ...
                    <li id="Men_Asignaturas" class=" nav-item"><a href="#"><i class="fa fa-book"></i><span
                        ...
                        <ul class="menu-content">
                            <li id="Men_Asignaturas_addAreas"><a class="menu-item"
                                    href="{{ url('/Asignaturas/GestionAreas/') }}"><i class="ft-list"></i>Gestionar
                                    Áreas</a>
                            </li>
                            <li id="Men_Asignaturas_addAsignatura"><a class="menu-item"
                                    href="{{ url('/Asignaturas/GestionAsignaturas/') }}"><i class="ft-list"></i>
                                    Asignaturas</a>
                            </li>
                            <li id="Men_Asignaturas_addAdig"><a class="menu-item"
                                    href="{{ url('/Asignaturas/GestionGrado/') }}"><i class="ft-list"></i>
                ...
                @if (Session::get('PerModE') == 'si')
                    <li id="Men_Modulos_E" class=" nav-item"><a href="#"><i class="fa fa-book"></i><span
                        ...
                        <ul class="menu-content">
                            ...
                            <li id="Men_ModulosE_Informe"><a class="menu-item"
                                    href="{{ url('/ModuloE/gestionInfSimulacros/') }}"><i class="ft-file-text"></i>
                                    Informe de Resultados</a>
                            </li>
                ...
                @if (Session::get('PerLabo') == 'si')
                    <li id="Men_Laboratorios" class=" nav-item"><a
                            href="{{ url('/Laboratorios/GestionLaboratorios/') }}"><i class="fa fa-flask"></i><span
                                class="menu-title" data-i18n="">Gestionar
                                Laboratorios</span></a>
                    </li>
                @endif
                ...
                <li id="Men_EstadisticasAdm" class=" nav-item"><a href="{{ url('/Gestion/EstadisticasAdmin/') }}"><i
                            class="ft-bar-chart"></i><span class="menu-title" data-i18n="">Datos
                            Estadisticos</span></a>
                </li>
                ...
                <li id="Men_RegUsuarios" class=" nav-item"><a href="{{ url('/Usuarios/RegistrosUsuarios') }}"><i
                            class="fa fa-id-card-o"></i><span class="menu-title" data-i18n="">Registros de Usuarios
                        </span></a>
                </li>
