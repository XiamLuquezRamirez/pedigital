...
<input type="hidden" name="origen_eval" value="C" />
...
<div class="row">
    ...
    <div class="col-md-12" id='rowtit'>
        <div class="form-group">
            <label class="form-label" for="titu_contenido">Título del Tema:</label>
    ...
    <div class="row ">
        <div class="col-md-12 col-lg-12 ">
            <div class="btn-list">
                ...
                @if($opc!='editar')
                <a class="btn btn-outline-warning" href="{{ url('/Asignaturas/AsigEvaluacion/' . $Tema->id) }}"
                    title="Cancelar">
                    <i class="fa fa-close"></i> Cancelar
                </a>
                @endif

                <a class="btn btn-outline-dark" href="{{ url('/Asignaturas/GestionAsigEvaluacion/' . $Tema->id) }}"
                    title="Volver">
