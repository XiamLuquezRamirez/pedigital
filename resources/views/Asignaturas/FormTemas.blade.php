...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="row" id='Cont_documento' style="display:none">
            ...
            <div class="col-md-12" style="display: none;" id="Div_ContDidactico">
                ...
                <div id="Arch_Didact" class="row">
                    <div class="col-md-11">
                        <input id="file" accept="video/*" class="form-control Selanima" name="archididatico[]" type="file">
                    </div>
                    <div class="col-md-1">
                ...
                <div class="col-lg-12" id="Div_ArcDidac" style="display:none">
                    <div class="form-group">
                        ...
                        <label id="projectinput7" class="file center-block">
                            <input id="file" name="archidida" type="file">
        ...
        <div class="row" id='Archivo' style="display:none">
            <div class="col-lg-12">
                <div class="form-group">
                    <label>Seleccionar Contenido a Subir:</label>
                    <label id="projectinput7" class="file center-block">
                        <input id="fileArch" accept="image/jpeg,image/gif,image/png,application/pdf,application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint"  multiple="" name="archi[]" type="file">
                        <span class="file-custom"></span>
                    </label>
                </div>
            </div>
