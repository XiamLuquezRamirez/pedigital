...
@section('title', 'Gestionar Asignaturas')
@section('Contenido')

    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Gestionar Asignaturas</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/Administracion') }}">Inicio</a>
                        </li>
                        <li class="breadcrumb-item active">Gestionar Asignaturas
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ url('/Asignaturas/NuevaAsig') }}"
                                ...
                                <p class="px-1"></p>
                                @include('Asignaturas.paginacionGestionAsignatura')
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {!! Form::open(['url' => '/Asignaturas/EliminarAsig', 'id' => 'formAuxiliar']) !!}
    {!! Form::close() !!}
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                error: function() {
                                    ...
                                    mensaje =
                                        "La Asignatura no pudo ser Eliminada!";
