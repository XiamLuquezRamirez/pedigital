...
<div class="content-header row">
    ...
    <div class="content-header-left col-md-12col-12 mb-2">
...
<script>
    ...
    $("#ModGrupos").modal({backdrop: 'static', keyboard: false});
    }
    ...
    type: "POST",
            ...
            $("#Text_presentacion").append(respuesta.presentacion.presentacion_modulo);
            },
            error: function () {
            swal(
                    'Error!',
    ...
    type: "POST",
            ...
            success: function (respuesta) {
            $("#Text_presentacion").html("");
            $("#Text_presentacion").append(respuesta.presentacion.objetivo_modulo);
            },
            error: function () {
            swal(
                    'Error!',
