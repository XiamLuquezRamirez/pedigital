...
@section('Contenido')
    ...
    <div class="content-body">
        <section id="number-tabs">
            <div class="row">
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="btn_ActIni" style="display: none;"
                                    onclick="$.AbrirAct('ACTINI');" class="btn btn-outline-pink"><i
                                        class="ft-user-check position-right"></i> Actividad De
                                    Inicio</button>
                                <button type="button" id="btn_Prod" style="display: none;"
                                    onclick="$.AbrirAct('PRODUC');" class="btn btn-outline-success"><i
                                        class="ft-user-check position-right"></i>
                                    Producción</button>
                                <button type="button" id="btn_atras" style="display: none;" onclick="$.mostListArc();"
                                    class="btn grey btn-outline-secondary"><i
                                        class="ft-corner-up-left position-right"></i>
                                    Atras</button>
                                <button type="button" id="btn_salir" onclick="$.mostLiistemas();"
                ...
                <div class="modal fade text-left" id="ModEval" tabindex="-1" role="dialog"
                                        ...
                                        <div class="content-header-left col-md-12 col-12">
                                            <div class="btn-group float-md-right" role="group"
                                                ...
                                                <a class="btn btn-outline-primary"><i class="ft-clock"> Tiempo para
                                                        Terminar</i></a>
                                                <a class="btn btn-outline-primary" style="color: #CE2605;"
                                                    id="cuenta"></a>
                                            </div>
                                        </div>
                                    </div>
    ...
    {!! Form::open(['url' => '/cambiar/ContenidoDocumento', 'id' => 'formContenidoDocumento']) !!}
    {!! Form::close() !!}
    ...
    {!! Form::open(['url' => '/cambiar/ContenidoVideo', 'id' => 'formContenidoVideo']) !!}
    {!! Form::close() !!}
    ...
    {!! Form::open(['url' => '/cambiar/ContenidoAnim', 'id' => 'formConsuAnim']) !!}
    {!! Form::close() !!}
    ...
    {!! Form::open(['url' => '/cambiar/habilContenido', 'id' => 'formHabiContenido']) !!}
    {!! Form::close() !!}

    {!! Form::open(['url' => '/cambiar/MostContenido', 'id' => 'formMostContenido']) !!}
    {!! Form::close() !!}
    ...
    {!! Form::open(['url' => '/Asignaturas/consulTemaPDF', 'id' => 'formGenPDFTema']) !!}
    {!! Form::close() !!}
                            ...
                            $.each(respuesta.Temas, function(i, item) {
                                ...
                                if (item.tip_contenido == "DOCUMENTO") {
                                    ...
                                    contenido +=
                                        ...
                                        .id + '" value="' + habi + '">' +
                                        '<div class="media align-items-stretch">' +
                                        '<div onclick="$.MostConteVideo(' + item
                                        .id +
                                        ');" class="d-flex align-items-center bg-' +
                                        rValue +
                                        ' position-relative callout-arrow-left p-2">' +
                                    ...
                                    contenido +=
                                        ...
                                        .id + '" value="' + habi + '">' +
                                        '<div class="media align-items-stretch">' +
                                        '<div onclick="$.MostConteLink(' + item.id +
                                        ');" class="d-flex align-items-center bg-' +
                                        rValue +
                                        ' position-relative callout-arrow-left p-2">' +
                            ...
                            $.ajax({
                                ...
                                success: function(respuesta) {
                                    ...
                                    $.each(respuesta.DesArch, function(i, item) {
                                        ...
                                        contenido += '<li id="' + j +
                                            '" onclick="$.mostmodArch(this.id);" style="cursor: pointer;" data-archivo="' +
                                            item.nom_arch +
                                            '" data-ruta="{{ asset('/app-assets/Archivos_Contenidos') }}"  class="list-group-item">' +
                                ...
                                success: function(respuesta) {
                                    ...
                                    $.each(respuesta.DesVid, function(i, item) {
                                        ...
                                        contenido += '<li id="' + j +
                                            ...
                                            '</span>' + item.titulo.substring(0,
                                                item.titulo.length - 4) +
                                            '  </li>';
                                        j++;
                                    });
                        ...
                        success: function(respuesta) {
                            $.each(respuesta.DesAnim, function(i, item) {
                                contenido +=
                                    ...
                                    .cont_didactico +
                                    '" data-ruta="{{ asset('/app-assets/Contenido_Didactico') }}" > <strong style="text-transform: capitalize;" >' +
