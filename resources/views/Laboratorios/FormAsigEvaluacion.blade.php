...
<input type="hidden" name="origen_eval" value="L" />
    ...
    <div class="row ">
        <div class="col-md-12 col-lg-12 ">
            <div class="btn-list">
                ...
                <a class="btn btn-outline-warning" href="{{ url('/Laboratorios/AsigEvaluacion/' . $Tema->id) }}"
                    title="Cancelar">
                    <i class="fa fa-close"></i> Cancelar
                </a>

                <a class="btn btn-outline-dark" href="{{ url('/Laboratorios/GestionAsigEvaluacion/' . $Tema->id) }}"
                    title="Volver">
